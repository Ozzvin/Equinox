...
// Without a saved choice the theme is the system's ("system" is what it is called when the person picks it).
try { var t = localStorage.getItem("uiTheme"); document.documentElement.dataset.theme = t === "light" || (t !== "dark" && !matchMedia("(prefers-color-scheme: dark)").matches) ? "light" : "dark"; } catch (e) { document.documentElement.dataset.theme = "dark"; }
